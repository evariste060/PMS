...
%>
    <div class="text-center max-w-md">
        ...
        <div class="w-24 h-24 rounded-full flex items-center justify-center mx-auto mb-6
            ...
            <i class="text-5xl
                <%= code == 404 ? "fas fa-map text-blue-400"
                  : code == 403 ? "fas fa-lock text-amber-400"
                  :               "fas fa-triangle-exclamation text-red-400" %>"></i>
        </div>
        ...
        <p class="text-gray-400 mb-8 text-sm leading-relaxed">
            <%= code == 404 ? "The page you're looking for doesn't exist or has been moved."
              ...
              :               "Something went wrong. Please go back and try again, or return to the home page." %>
        </p>
