...
<head>
    ...
    <title>PMS &mdash; Add Nurse</title>
...
<div class="flex min-h-screen">
    ...
    <main class="flex-1 ml-64">
        <header class="bg-white shadow-sm px-8 py-4 flex items-center gap-3 sticky top-0 z-10">
            <a href="${pageContext.request.contextPath}/doctor/nurses" class="text-gray-400 hover:text-gray-600 transition">
                <i class="fas fa-arrow-left"></i>
            </a>
            <div>
                <h1 class="text-xl font-bold text-gray-800">Register Nurse</h1>
                <p class="text-gray-400 text-xs mt-0.5">Create a new nurse account under your supervision</p>
            </div>
        </header>
        ...
        <div class="p-8 max-w-3xl">
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-8">
                <form action="${pageContext.request.contextPath}/doctor/add-nurse" method="post" class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input type="text" name="username" required
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm" placeholder="e.g. nurse_jane"/>
                            </div>
                            <div>
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                            ...
                            <div>
                                ...
                                <input type="email" name="email"
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm" placeholder="nurse@clinic.com"/>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-700 mb-1.5">Health Center <span class="text-red-500">*</span></label>
                                <input type="text" name="healthCenter" required
                                       class="w-full px-4 py-2.5 border border-gray-300 rounded-xl bg-white focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm" placeholder="Health center name"/>
                            </div>
                            <div>
                    ...
                    <div class="flex gap-3 pt-2">
                        <button type="submit"
                            ...
                            <i class="fas fa-user-plus"></i> Register Nurse
                        </button>
